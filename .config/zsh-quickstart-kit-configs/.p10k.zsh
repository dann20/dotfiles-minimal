# Generated by Powerlevel10k configuration wizard on 2022-04-19 at 03:14 +07.
...
() {
  ...
  # typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_DEFAULT_ENV:t} - python ${P9K_ANACONDA_PYTHON_VERSION}}'
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${P9K_ANACONDA_PYTHON_VERSION} (${CONDA_DEFAULT_ENV:t})}'
